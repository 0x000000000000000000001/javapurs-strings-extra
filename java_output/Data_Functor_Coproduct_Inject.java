...
public static final Object injectLeft = new java.util.LinkedHashMap<String, Object>() {{ put("inj", (java.util.function.Function<Object, Object>) (x_0) -> new Data_Either.Left(x_0)); put("prj", (java.util.function.Function<Object, Object>) (v2_0) -> ( ((Boolean) ((v2_0 instanceof Data_Either.Left))) ? new Data_Maybe.Just((((Data_Either.Left) v2_0).value0)) : ( ((Boolean) ((v2_0 instanceof Data_Either.Right))) ? new Data_Maybe.Nothing() : ((java.util.function.Supplier<Object>) () -> { throw new RuntimeException("Failed pattern match"); }).get()))); }};
